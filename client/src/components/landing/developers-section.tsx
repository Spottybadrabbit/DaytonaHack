...
const features = [
  { title: "TypeScript native", description: "Full type safety for agent configs and responses." },
  { title: "Streaming results", description: "Watch your agents think and act in real-time." },
  { title: "Multi-model support", description: "OpenAI, Anthropic, Mistral, or bring your own." },
  { title: "Local debugging", description: "Test agents locally before deploying to cloud." },
];
